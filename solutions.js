...
// -- *Check answers in the JS console in the browser* --- //
...
// addOne(NaN)                  // NaN
    ...
    // could also use parseInt to return the numeric value (+1) from a string.
...
// isEven("banana")            // false
    ...
    function isEven(input) {
        if (input % 2 === 0 && !isTrue(input) && !isFalse(input)){
            return true;
        } else {
            return false;
        }
...
// % (modulus) tells us if a number is even or odd.
...
// concat(true, true)                  // "truetrue"
    ...
    //  --- ALTERNATE SOLUTION ---
    //  function concat (in1, in2) {
    //        return in1.stString() + in2.toString();
    //  }
